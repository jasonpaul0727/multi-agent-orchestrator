...
internal, opt-in read-only command path. The Tool Gateway evaluates a frozen
...
not implement workspace writes, artifact publication, approval-grant
consumption, or a Secret Broker; requests needing approval remain blocked.

...
预设、DIY 配置与模型路由设计已逐节获得用户确认；正式规格位于 `docs/superpowers/specs/2026-09-11-presets-routing-design.md`，当前等待用户审阅书面规格。

## 待确认的设计部分

权限、安全、隔离与审批，以及持久化、成本统计、可观测性和测试方案等后续设计尚未开始。

## 后续设计顺序

1. 用户审阅并批准预设、DIY 配置与模型路由书面规格。
2. 设计权限、安全、隔离和审批模型。
